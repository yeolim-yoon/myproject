  ...
  sidebar = dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Infection Route", icon = icon("table"), startExpanded = TRUE,
               ...
               menuSubItem("Area by Route", tabName ="area_by_route",  icon = icon("angle-right")),
               menuSubItem("Route by Area", tabName ="route_by_area",  icon = icon("angle-right"))),
  ...
  body    = dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "cases_seoul",
              ...
              box(width = NULL, status = "primary", solidHeader = TRUE, title="Infection Route by Area Plot",  br(), plotOutput("route3_plot3", height = 600), 
